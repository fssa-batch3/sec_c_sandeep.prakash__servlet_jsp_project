...
<div class="mainpoage">
            ...
            <div class="sidebar1">
                <div class="profilebox">
                    <div class="profileimgplace">
                        <img class="profileimg" src="https://freeimage.host/i/HkW7U4S" alt="profile">
 ...
 <i class="bx bxs-grid-alt"></i>
                ...
                <button class="logout" c role="button">
                ...
                <div class="container2">
                    ...
                    <div class="forms">
                        ...
                        >
                            ...
                            <input type="name" name="fname" id="name1" pattern="^[a-zA-Z]{3,20}$"
                                ...
                                disabled required>
                                      <input type="name" name="lname"id="name2" pattern="^[a-zA-Z]{3,20}$"
                                title="the input field  should contains only alphabetic characters (both upper and lower case) and has a length between 3 and 20 characters."
                                disabled required>
                                </div>
                            <br>
                            ...
                            <br>
                            <input type="email" id="userEmail" name="uemail"aria-label="email" disabled>
                            <br>
                            <label class="labelname">Phone Number:</label>
                            <br>
                            <input type="text" id="phoneno1"  name="uphonenumber" aria-label="phone number"
                            ...
                            <br>
                            <input type="number" id="age"  name="uage" min="8" max="90" pattern="^(1[8-9]|[2-9][0-9])$"
                                title="The age should contain 1 to 120" disabled>
                            <br>
                            <br>
                            <p class="labelnamegen">Gender</p>
                            <br>
 <select  placeholder="Gender " name="ugender" id="gender" aria-label="gender" disabled>
    ...
    <option value="gender nonconforming">Gender Nonconforming</option>
                            ...
                            <div class="select">
                                ...
                                <div id="sportss" required>
                                    ...
                                    <input type="checkbox" id="sportsavail1" aria-label="sportsavail" name="sportsKnown"
                                        value="Cricket" disabled>
                                    <label class="sportname1">Cricket</label>
                                    <br>
                                    <input type="checkbox" id="sportsavail2" aria-label="sportsavail" name="sportsKnown"
                                        value="Football" disabled>
                                    <label class="sportname2">Football</label>
                                    <br>
                                    <input type="checkbox" id="sportsavail3" aria-label="sportsavail" name="sportsKnown"
                                ...
                                <br>
                                <br>
                                <select id="locationselect" name="ulocation" disabled>
                                ...
                                <br>
                                <input type="text" id="startTime" name="ustartTime" required placeholder="12:00" disabled>
                                <!-- <input type="time" id="timingsfrom" aria-label="timingsfrom" value="4:00" disabled> -->
                                <br>

                                <p class="timep">To</p>
                                <input type="text" id="endTime"name="uendTime" required placeholder="12:00" disabled>
                                <br>
                                <!-- <input type="time" id="timingsto" aria-label="timingtoo" value="5:00" disabled> -->
                                <br>

                                <span class="linetext">Few lines About You</span>
                                <textarea class="textabout" pattern="^[a-zA-Z ]{3,70}$" name="uabout"
    ...
    <script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
    	...
    	<script type="text/javascript" src="/bookandplay-web/assets/js/userprofile.js"></script>
