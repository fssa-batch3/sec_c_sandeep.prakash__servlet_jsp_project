...
<head>
    ...
    <link rel="stylesheet" href="/bookandplay-web/assets/css/playermessage.css">
...
<body>
	...
	<script type="text/javascript" src="/bookandplay-web/assets/js/playermessage.js"></script>
