<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.fssa.bookandplay.model.User"%>
<!DOCTYPE html>
<html>
<head>
...
<!-- header -->
  ...
  <div class="maindiv1">
    ...
    <div class="center">
      <img class="allsports" src="/bookandplay-web/assets/images/allsports.png" alt="Book and play">

      <h1 class="word1">
Book Your Grounds From Your Place <br>
<span class="connect"
          style="color:rgb(56, 44, 186)">Connect Players</span></h1>
      <img class="cricketplayer" src="/bookandplay-web/assets/images/cricketplayer.png" alt="Book and play">
    </div>
    <div class="box">
      <div class="perbox1">
        <img class="profilerounds" src="/bookandplay-web/assets/images/profileround.png" alt="Book and play">

      </div>
      <div class="perbox2">
        <img class="profilerounds" src="/bookandplay-web/assets/images/grirlround.png" alt="Book and play">

      </div>
      <div class="perbox3">

        <img class="profilerounds3" src="/bookandplay-web/assets/images/roundcoach-.png" alt="Book and play">

      </div>
      <div class="perbox4">
        <img class="profilerounds3" src="/bookandplay-web/assets/images/avatars_n-.png" alt="Book and play">

      </div>

    </div>

    <img class="leftgreen" src="/bookandplay-web/assets/images/blob-scene-haikei__4_-removebg-preview.png" alt="Book and play">

    <img class="rightgreen" src="/bookandplay-web/assets/images/blob-scene-haikei__4_-removebg-previewrigth.png" alt="Book and play">
    </header>
  </div>
  ...
  <div class="maindiv2">
    <img class="design1" src="/bookandplay-web/assets/images/sratch1.png" alt="Book and play">
    ...
    <div class="tagmainbox">
      <div class="tagbox">
        ...
        <img class="groundicon" src="/bookandplay-web/assets/images/groundicon.png" alt="ground">
        ...
        <div class="sportsicon">
          <img class="cricketicon" src="/bookandplay-web/assets/images/cricketicon.png" alt="cricketicon">
          <img class="cricketicon" src="/bookandplay-web/assets/images/footballicon.png" alt="cricketicon">
          <img class="cricketicon" src="/bookandplay-web/assets/images/tennisicon.png" alt="cricketicon">
      ...
      <div class="tagbox">
        ...
        <img class="usericon" src="/bookandplay-web/assets/images/groupuser.png" alt="ground">
      ...
      <div class="tagbox">
        ...
        <img class="usericon" src="/bookandplay-web/assets//images/manageuser.png" alt="ground">
  ...
  <div class="maindiv3">
    ...
    <div class="photocolumn">
      <img class="peoplechatting" src="/bookandplay-web/assets/images/people chatting.png" alt="ground">
  ...
  <div class="reviewdiv">
    <div class="review">
      <div class="person">
        <p>Person1</p>
<br>
        <img class="personimg" src="/bookandplay-web/assets/images/reviewer1.jpg" alt="person1">
<br>
<div class="star">
...
<br>
      ...
      <div class="person">
        <p>Person2</p>
<br>
        <img class="personimg" src="/bookandplay-web/assets/images/reviewer2.jpg" alt="person1">
<br>
<div class="star">
  <i class="fa-solid fa-star" style="color: #ffcc00;"></i>
  <i class="fa-solid fa-star" style="color: #ffcc00;"></i>
...
<br>
      ...
      <div class="person">
        <p>Person3</p>
<br>
        <img class="personimg" src="/bookandplay-web/assets/images/reviewer3.jpg" alt="person1">
<br>
...
<br>
  ...
  <div class="maindiv4">
    <img class="design1" src="/bookandplay-web/assets/images/sratch1.png" alt="Book and play">
    <div class="chatcolu">
      <img class="peoplechatting" src="/bookandplay-web/assets/images/chatfeature.png" alt="ground">
