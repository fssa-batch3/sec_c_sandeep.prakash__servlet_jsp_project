...
<head>
    ...
    <link rel="stylesheet" href="/bookandplay-web/assets/css/friendrequest.css">
...
<script type="text/javascript" src="/bookandplay-web/assets/js/friendrequest.js"></script>
</body>
</html>
