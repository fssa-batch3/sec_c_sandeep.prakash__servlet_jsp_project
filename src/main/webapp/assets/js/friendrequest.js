...
//console.log(filterPlayer);
 ...
 axios.get(url)
   ...
   axios.get(`http://localhost:8080/bookandplay-web/GetFriendRequestList?receiverId=${userId}`)
  .then(function (response) {
	  //console.log(response.data)  
let filterData = [];
...
const url = "http://localhost:8080/bookandplay-web/AcceptFriendRequest?"; 
...
const url = "http://localhost:8080/bookandplay-web/RejectFriendRequest?"; 
